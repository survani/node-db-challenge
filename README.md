...
- Answer: Relational Databases and SQl differences are that one is for querying the other one.

- [ ] Why do tables need a `primary key`?

- Answer: The table needs a primary key so we are able to make it unique. It also brings accessibilty into play.

- [ ] What is the name given to a table column that references the primary key on another table.

- Answer: It will be called => Foreign Key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.

multiple records in table + they are connected with more records in some other table. It is a big connection chain!
